...
TARGET := tyrian
OBJS := config.o error.o episodes.o fonthand.o helptext.o joystick.o keyboard.o lvlmast.o newshape.o nortsong.o nortvars.o opentyr.o pallib.o params.o picload.o setup.o pcxload.o pcxmast.o shpmast.o starfade.o tyrian2.o varz.o vga256d.o
