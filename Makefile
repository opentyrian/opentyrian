...
TARGET := tyrian
OBJS := config.o error.o episodes.o fonthand.o helptext.o joystick.o keyboard.o lvllib.o loudness.o lvlmast.o mainint.o musmast.o newshape.o nortsong.o nortvars.o opentyr.o pallib.o params.o picload.o setup.o pcxload.o pcxmast.o shpmast.o sndmast.o starfade.o tyrian2.o varz.o vga256d.o
