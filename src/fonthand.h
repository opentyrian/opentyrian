...
void JE_Dstring(JE_word x, JE_word y, char *s, JE_byte font);
...
JE_word JE_FontCenter(char *s, JE_byte font);
JE_word JE_TextWidth(char *s, JE_byte font);
void JE_TextShade(JE_word x, JE_word y, char *s, JE_byte colorbank, JE_shortint brightness, JE_byte shadetype);
void JE_Outtext(JE_word x, JE_word y, char *s, JE_byte colorbank, JE_shortint brightness);
void JE_OuttextModify(JE_word x, JE_word y, char *s, JE_byte filter, JE_byte brightness, JE_byte font);
void JE_OuttextShade(JE_word x, JE_word y, char *s, JE_byte font);
void JE_OuttextAdjust(JE_word x, JE_word y, char *s, JE_byte filter, JE_shortint brightness, JE_byte font, JE_boolean shadow);
char JE_Bright(JE_boolean makebright);

void JE_UpdateWarning();
void JE_Outtextglow(JE_word x, JE_word y, char *s);
void JE_OuttextANDDarken(JE_word x, JE_word y, char *s, JE_byte colorbank, JE_byte brightness, JE_byte font);
