...
void JE_playerMovement( Player *this_player, JE_byte inputDevice, JE_byte playerNum, JE_word shipGr, Sprite2_array *shapes9ptr_, JE_word *playerInvulnerable, int *PX, int *PY, JE_integer *lastPX2, JE_integer *lastPY2, JE_integer *PXChange, JE_integer *PYChange, JE_integer *lastTurn, JE_integer *lastTurn2, JE_byte *stopWaitX, JE_byte *stopWaitY, JE_word *mouseX, JE_word *mouseY, JE_boolean *playerAlive, JE_byte *playerStillExploding );
void JE_mainGamePlayerFunctions( void );
const char *JE_getName( JE_byte pnum );

void JE_playerCollide( Player *this_player, int *px, int *py, JE_integer *lastTurn, JE_integer *lastTurn2, JE_boolean *playerAlive, JE_byte *playerStillExploding, JE_byte playerNum, JE_byte playerInvulnerable );
